...
function renderCookTotalCostLine(totalFlower, iconHtml, modeLabel, extraClass) {
    ...
    el.oninput = () => {
      ...
      if (totalLine) {
        ...
        if (n > 1) {
          ...
          totalLine.innerHTML = `${fmt(unitCost * effectiveCount)} ${typeof FLOWER_ICON !== "undefined" ? FLOWER_ICON : "FLOWER"} total for ${effectiveCount}× ${iconHtml}`;
        } else {
  ...
  wrap.querySelectorAll(".cook-food-count").forEach(el => {
    ...
    el.oninput = () => {
      ...
      if (totalLine) {
        ...
        if (n > 1) {
          totalLine.style.display = "";
          totalLine.innerHTML = `${fmt(unitCost * effectiveCount)} ${FLOWER_ICON} FLOWER total for ${effectiveCount}× ${iconHtml}`;
        } else {
          totalLine.style.display = "none";
        }
      }
